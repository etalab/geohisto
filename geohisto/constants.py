...
CREATION_NOT_DELEGATED_POLE = 321
...
INTERCOMMUNALITY_INNER_CHANGE = 'inner'
INTERCOMMUNALITY_RENAMED = 'renamed'
INTERCOMMUNALITY_KIND_CHANGE = 'kind'
INTERCOMMUNALITY_TAXMODEL_CHANGE = 'taxmodel'
INTERCOMMUNALITY_REMOVED = 'removed'
INTERCOMMUNALITY_MERGED = 'merged'

INTERCOMMUNALITY_START_DATE = date(1999, 1, 1)
