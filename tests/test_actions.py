...
from geohisto.constants import (
	...
	CHANGE_NAME_FUSION, CHANGE_NAME_REINSTATEMENT, CREATION, CREATION_DELEGATED,
	CREATION_DELEGATED_POLE, CREATION_NOT_DELEGATED, CREATION_NOT_DELEGATED_POLE,
	CREATION_PREEXISTING_ASSOCIATED, DELETION_FUSION, DELETION_PARTITION,
	END_DATE, END_DATETIME, FUSION_ABSORPTION, FUSION_ASSOCIATION_ASSOCIATED,
	OBSOLETE, REINSTATEMENT, SPLITING, START_DATE, START_DATETIME
)
