...
def test_rename(towns, history_list):  # NOQA: fixtures.
    ...
    assert neuville_s.id == '102631942-01-01T00:00:002008-10-06T00:00:00'
    assert neuville_s.nccenr == 'Neuville-sur-Vannes'
    assert neuville_s.start_date == START_DATE
    assert neuville_s.end_date == datetime(2008, 10, 6, 0, 0, 0)
...
def test_fusion(towns, history_list):  # NOQA: fixtures.
    ...
    assert braguelogne.id == '100581942-01-01T00:00:001973-05-01T00:00:00'
    ...
    assert (beauvoir_sur_sarce.id
            == '100361942-01-01T00:00:001973-05-01T00:00:00')
...
def test_fusion_then_split(towns, history_list):  # NOQA: fixtures.
    ...
    assert framboisiere.id == '281591942-01-01T00:00:001972-12-22T00:00:00'
    ...
    assert saucelle.id == '283681942-01-01T00:00:001972-12-22T00:00:00'
    ...
    assert framb_saucelle.id == '281591972-12-22T00:00:001987-01-01T00:00:00'
    assert framb_saucelle.successors == framb2.id + ';' + sauc2.id
    assert (framb_saucelle.modification
            == '{};{}'.format(SPLIT_LEADER, SPLIT_FOLLOWER))
    assert framb.id == '281591942-01-01T00:00:001972-12-22T00:00:00'
    ...
    assert sauc.id == '283681942-01-01T00:00:001972-12-22T00:00:00'
...
def test_fusion_then_reinstatement_then_split(towns, history_list):  # NOQA: fixtures.
    ...
    assert varenne.id == '525041942-01-01T00:00:001972-08-01T00:00:00'
    assert terre_natale.id == '525041972-08-01T00:00:002012-01-01T00:00:00'
    assert varenne2.id == '525042012-01-01T00:00:009999-12-31T23:59:59'
    assert champigny.id == '521031942-01-01T00:00:001972-08-01T00:00:00'
    assert champigny2.id == '521031986-01-01T00:00:009999-12-31T23:59:59'
    assert chezeau.id == '521241942-01-01T00:00:001972-08-01T00:00:00'
...
def test_fusions_to_new_delegated(towns, history_list):  # NOQA: fixtures.
    ...
    assert obedorf.id == '682401942-01-01T00:00:002016-01-01T00:00:00'
    assert grentzingen.id == '681081942-01-01T00:00:002016-01-01T00:00:00'
    assert henflingen.id == '681331942-01-01T00:00:002016-01-01T00:00:00'
...
def test_fusions_to_new_not_delegated(towns, history_list):  # NOQA: fixtures.
    ...
    assert fragnes.id == '712041942-01-01T00:00:002016-01-01T00:00:00'
    assert loyere.id == '712651942-01-01T00:00:002016-01-01T00:00:00'
...
def test_deletions(towns, history_list):  # NOQA: fixtures.
    ...
    assert creusy.id == '451171942-01-01T00:00:001965-01-01T00:00:00'
...
def test_obsoletes(towns, history_list):  # NOQA: fixtures.
    ...
    assert (hauteville_lompnes.id
            == '014591942-01-01T00:00:001942-08-01T00:00:00')
...
def test_change_county(towns, history_list):  # NOQA: fixtures.
    ...
    assert old_afa.id == '200011942-01-01T00:00:001976-01-01T00:00:00'
