...
def test_counts(towns):
    ...
    assert len(towns.valid_at(datetime(1975, 1, 1, 0, 0, 0))) - 36407 == i + 115  # NOQA
    assert len(towns.valid_at(datetime(1982, 1, 1, 0, 0, 0))) - 36547 == i + 16
    ...
    assert len(towns.valid_at(datetime(2016, 1, 1, 0, 0, 0))) - 35885 == i + 7
    assert len(towns.valid_at(datetime(2017, 1, 1, 0, 0, 0))) - 35416 == i + 15
